...
NDJSON files can be large, and are easy to iterate through. The
queries are therefore processed in 'chunks', and a finite number of
...
Note that `n_records` refers to the number of lines input, rather than
the number of lines satisfying `path=`.
